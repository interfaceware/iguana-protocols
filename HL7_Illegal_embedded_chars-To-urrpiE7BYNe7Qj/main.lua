...
-- http://help.interfaceware.com/v6/hl7-illegal-embedded-chars

hl7.fix = require 'hl7.delimiter.fix'

function main(Data)

   --This is the illegal HL7 data - see the embedded "&" characters 
   -- in the first OBX segment?
   trace(Data)
   local Data = hl7.fix{data=Data, segment='OBX',field_index=5}

   --And this is after we have fixed it.
   trace(Data)
